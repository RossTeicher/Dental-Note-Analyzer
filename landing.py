...
# Set page config
st.set_page_config(page_title="ToothWise", page_icon="🧠", layout="centered")
...
st.markdown("### 🚀 What ToothWise Does")
features = [
...
with open("Treatment_Options_And_Risks.pdf", "rb") as f:
    st.download_button("📥 Download PDF Example", data=f, file_name="ToothWise_Demo.pdf", mime="application/pdf")
...
“Dentists should focus on patient care — not paperwork. That’s why I built ToothWise.”

*Implants. Sedation. TMJ. General Dentistry.* Now fully AI-powered.
""")

st.markdown("### 🧪 Ready to Try It?")
st.page_link("app.py", label="🦷 Launch the ToothWise Demo", icon="🧠")
